...
describe("Anmalan/Restriktioner", () => {
    URLSUFIX.forEach((urlsf) => {
        ...
        Cypress._.times(RERUNS, (index) => {
            it(`FeatureServer - ${KarttjansURL}/services/Anmalan/Restriktioner/FeatureServer?f=pjson - Run ${index + 1}`, () => {
                cy.fixture('karttjanster/Anmalan/Restriktioner/FeatureServer').then((fixture) => {
